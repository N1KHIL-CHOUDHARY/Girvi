      ...
      {isTicketLoading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <p className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">{ticket.ticket_number}</p>
                </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="rounded-xl bg-neutral-50 p-3 dark:bg-neutral-800">
                  ...
                  <p className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 flex items-center gap-1">
                    <IconCurrencyRupee className="h-4 w-4" /> {ticket.original_loan_amount ?? ticket.loan_amount}
                  </p>
                </div>
                <div className="rounded-xl bg-green-50 p-3 dark:bg-neutral-800">
                  <p className="text-xs text-neutral-500">Current Balance</p>
                  <p className="text-lg font-semibold text-green-800 dark:text-green-200 flex items-center gap-1">
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
              <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 mb-2">Items</p>
              <div className="space-y-3">
                {(ticket.items || []).map((item, idx) => (
                  <div key={idx} className="rounded-xl border border-neutral-200 p-3 text-sm dark:border-neutral-800">
                    <p className="font-semibold text-neutral-900 dark:text-neutral-100">{item.name}</p>
                    <p className="text-neutral-600 dark:text-neutral-300">{item.type}</p>
                    <p className="text-neutral-600 dark:text-neutral-300">{item.weight_grams} g · {item.purity || 'N/A'} purity</p>
                  </div>
                ))}
                {!ticket.items?.length && (
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-base font-semibold text-neutral-900 dark:text-neutral-100">Add Payment</h3>
              </div>
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-neutral-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-base font-semibold text-neutral-900 dark:text-neutral-100">Payment History</h3>
              </div>
              {isPaymentsLoading ? (
                  ...
                  <table className="min-w-full text-sm">
                    ...
                    <tbody>
                      {payments.map((payment) => (
                        <tr key={payment._id} className="border-b border-neutral-100 dark:border-neutral-800">
