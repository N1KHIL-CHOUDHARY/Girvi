...
export default function LandingPage() {
  return (
    <div className="overflow-x-hidden">
      <div className="min-h-screen w-full bg-gradient-to-b from-white to-neutral-100 dark:from-black dark:to-neutral-900 text-neutral-900 dark:text-neutral-100">
        
        {/* --- NAVBAR --- */}
        <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-white/70 dark:bg-black/60 border-b border-neutral-200/50 dark:border-neutral-800/50">
