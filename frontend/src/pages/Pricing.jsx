      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <header className="mb-10 md:mb-14 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Simple pricing for growing pawn shops
          </h1>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <section
            ...
            className="border border-slate-200 rounded-2xl p-8 shadow-sm"
          >
            <h2
              id="starter-plan-title"
              className="text-2xl font-semibold text-slate-900 mb-2"
            >
              Starter – for new pawn shops
            </h2>
          ...
          <section
            ...
            className="border border-blue-500 rounded-2xl p-8 shadow-md ring-1 ring-blue-100"
          >
            <h2
              id="growth-plan-title"
              className="text-2xl font-semibold text-slate-900 mb-2"
            >
              Growth – for busy pawn shops
            </h2>
            <p className="text-3xl font-bold text-slate-900 mb-1">
              Custom
