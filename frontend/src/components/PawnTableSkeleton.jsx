      ...
      <TableBody>
        {skeletonRows.map((row) => (
          <TableRow key={row} className="hover:bg-transparent dark:hover:bg-transparent">
            <TableCell>
              <div className="h-4 w-20 rounded bg-gray-200 dark:bg-neutral-800 animate-pulse"></div>
            </TableCell>
            <TableCell>
            ...
            <TableCell>
              <div className="h-6 w-16 rounded-full bg-gray-200 dark:bg-neutral-800 animate-pulse"></div>
            </TableCell>
