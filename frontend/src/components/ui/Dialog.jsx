  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-h-[calc(100dvh-env(safe-area-inset-top)-env(safe-area-inset-bottom)-env(keyboard-inset-height,0px)-2rem)]",
        "md:max-h-[calc(100dvh-env(safe-area-inset-top)-env(safe-area-inset-bottom)-2rem)]",
