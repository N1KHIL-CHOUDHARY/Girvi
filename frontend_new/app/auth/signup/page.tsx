    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F7F8FA] p-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-100 bg-white p-8 shadow-sm sm:p-10">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">Start managing your pawn shop in one smart system.</p>
        </div>
        ...
        <form className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input placeholder="Nikhil" className={inputClass} />
            </div>
            <div>
              <label className={labelClass}>Last Name</label>
              <input placeholder="H" className={inputClass} />
            </div>
          </div>

          <div>
            <label className={labelClass}>Shop Name</label>
            <input placeholder="Nikhil Pawn Shop" className={inputClass} />
          </div>
